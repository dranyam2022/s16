...
console.log(`132 degress Celsius when converted to Farenheit is ${resultFahrenheit}`)
...
let num7 = 165;
//Log the value of the remainder in the console.
let resultIsDivisibleBy8 = num7 % 8;
console.log(`The remainder of 165 divided by 8 is: ${resultIsDivisibleBy8}`)
console.log("Is num7 divisible by 8?");
let isDivisibleBy8 = (resultIsDivisibleBy8 === 0);
//Log the value of isDivisibleBy8 in the console.
...
*/
let num8 = 348;
let resultIsDivisibleBy4 = (num8 % 4);
console.log(`The remainder of 348 divided by 4 is: ${resultIsDivisibleBy4}`);
//Log the value of the remainder in the console.
console.log("Is num8 divisible by 4?");
//Log the value of isDivisibleBy4 in the console.
let isDivisibleBy4 = resultIsDivisibleBy4 === 0;
